# === Complete YOLO11 Real Dataset Training - Single Cell ===
# Downloads real datasets, fixes paths, trains model, saves to Google Drive

# === REQUEST GOOGLE DRIVE PERMISSION FIRST ===
...
# === Save to Google Drive (Auto-Save After Training) ===
if training_success:
...
"""
        ...
        print("\n🎉 SUCCESS: Everything auto-saved to Google Drive!")
